...
********************************************************************/
#include <ros/ros.h>
#include <std_msgs/String.h>        //a header generated automatically from the String.msg file
...
int main( int argc, char** argv )
{
    ...
    ros::init(argc, argv, "turtle_control",ros::init_options::AnonymousName);  //3--we specify the name of our node. Node names must be unique in a running system.
    ...
    //turtleF.getLocalPose();
    ros::ServiceServer service=n.advertiseService("TurtlePose",/*service建立，在ROS中发布*/
    ...
    //ADVERTIZE THE TOPIC
    ros::Publisher pub=n.advertise<turtle_vis::DesiredPose>("turtle_control",100); //?DesiredPose是用的turtle_vis中msg文件的名字
    ...
    while(ros::ok())
    {
        ...
        turtlePose_desired_local=turtleF.turtlePose_desired_g;  //
